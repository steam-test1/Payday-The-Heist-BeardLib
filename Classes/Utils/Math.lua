...
function E.step(a, b, t)
	return mstep(a, b, t)
end

function E.linear(a, b, t)
    return mlerp(a, b, t)
end

function E.in_quad(a, b, t)
    return (b - a) * t * t + a
end

function E.out_quad(a, b, t)
    return -(b - a) * t * (t - 2) + a
end

function E.inout_quad(a, b, t)
    t = t * 2
...
function E.outin_quad(a, b, t)
    t = t * 2
    local c = (b - a) * 0.5

    if t < 1 then
        return E.out_quad(a, c, t)
    else
        return E.in_quad(a + c, b, t - 1) + c
    end
end

function E.in_cubic(a, b, t)
    return (b - a) * t * t * t + a
end

function E.out_cubic(a, b, t)
    t = t - 1

    return (b - a) * (t * t * t + 1) + a
end

function E.inout_cubic(a, b, t)
    t = t * 2
...
function E.outin_cubic(a, b, t)
    t = t * 2
    local c = (b - a) * 0.5

    if t < 1 then
        return E.out_cubic(a, c, t)
    else
        return E.in_cubic(a + c, b, t - 1) + c
    end
end

function E.in_quart(a, b, t)
    return (b - a) * t * t * t * t + a
end

function E.out_quart(a, b, t)
    t = t - 1

    return -(b - a) * (t * t * t * t - 1) + a
end

function E.inout_quart(a, b, t)
    t = t * 2
...
function E.outin_quart(a, b, t)
    t = t * 2
    local c = (b - a) * 0.5

    if t < 1 then
        return E.out_quart(a, c, t)
    else
        return E.in_quart(a + c, b, t - 1) + c
    end
end

function E.in_quint(a, b, t)
    return (b - a) * t * t * t * t * t + a
end

function E.out_quint(a, b, t)
    t = t - 1

    return (b - a) * (t * t * t * t * t + 1) + a
end

function E.inout_quint(a, b, t)
    t = t * 2
...
function E.outin_quint(a, b, t)
    t = t * 2
    local c = (b - a) * 0.5

    if t < 1 then
        return E.out_quint(a, c, t)
    else
        return E.in_quint(a + c, b, t - 1) + c
    end
end

function E.in_expo(a, b, t)
    if t == 0 then
        return a
    else
        local c = b - a
...
function E.outin_expo(a, b, t)
    t = t * 2
    local c = (b - a) * 0.5

    if t < 1 then
        return E.out_expo(a, c, t)
    else
        return E.in_expo(a + c, b, t - 1) + c
    end
end
function E.step(a, b, t)
    return mstep(a, b, t)
