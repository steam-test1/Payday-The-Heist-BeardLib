...
FrameworkBase._ignore_folders = {["base"] = true, ["BeardLib"] = true, ["PAYDAY-2-BeardLib-master"] = true, ["Payday-The-Heist-BeardLib"] = true, ["downloads"] = true, ["logs"] = true, ["saves"] = true}
